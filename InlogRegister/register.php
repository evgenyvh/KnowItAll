...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    $username_err = "Dit gebruikersnaam is in gebruik";
                } else{
    ...
    if(empty(trim($_POST["password"]))){
        $password_err = "Maak hier een nieuwe wachtwoord aan.";
    } elseif(strlen(trim($_POST["password"])) < 6){
        $password_err = "Wachtwoord moet minimaal 6 dingen hebben.";
    } else{
    ...
    if(empty(trim($_POST["confirm_password"]))){
        $confirm_password_err = "Herhaal hier u wachtwoord.";
    } else{
...
<div class="wrapper">
    <h2>Registreren</h2>
    <p>Maak hier een nieuwe acoount aan.</p>
